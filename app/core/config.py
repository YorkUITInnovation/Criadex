...
GRAPH_FALLBACK_MAX_DOCS: int = int(os.environ.get("GRAPH_FALLBACK_MAX_DOCS", "300"))
GRAPH_FALLBACK_MAX_DOC_CHARS: int = int(os.environ.get("GRAPH_FALLBACK_MAX_DOC_CHARS", "4000"))
